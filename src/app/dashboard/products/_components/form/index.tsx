...
import { CONDITIONS_PRODUCT_OPTIONS, DEFAULT_YES_NOT_OPTIONS, TIPO_VENDA_OPTIONS, SITUATIONS_PRODUCT_OPTIONS, UNIT_MEASUREMENT_PRODUCT_OPTIONS } from '@/constants/types';
      ...
      <Select
        ...
        /> */}
          ...
          <Select
            ...
            errors={reactHookForm.formState.errors.destaque?.message}
            {...reactHookForm.register('destaque')}
            options={DEFAULT_YES_NOT_OPTIONS}
          />
          <Select
            placeholder='Tipo de venda'
            errors={reactHookForm.formState.errors.tipo_venda?.message}
            {...reactHookForm.register('tipo_venda')}
